/**
 * Run migration 024: Add cup-week league default lineup column.
 *
...
async function runMigration() {
  console.log('Running migration 024: Add default_lineups.cup_week_player_ids...\n')

  const migrationPath = path.join(
    __dirname,
    '../supabase/migrations/024_add_cup_week_default_lineup.sql'
  )
