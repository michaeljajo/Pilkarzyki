...
"[project]/src/app/api/cups/[id]/schedule/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, context) {
    try {
      ...
      `).eq('cup_id', cupId).order('cup_week', {
        ...
        const { data: cup } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('cups').select('league_id').eq('id', cupId).single();
        ...
        const { data: squads } = cup ? await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('squads').select('manager_id, team_name').eq('league_id', cup.league_id).in('manager_id', Array.from(managerIds)) : {
            data: null
        };
        ...
        const schedule = cupGameweeks?.map((gameweek)=>({
                ...gameweek,
                matches: gameweek.cup_matches?.map((match)=>({
                        ...match,
...
async function POST(request, context) {
    try {
        ...
        if (!gameweekMappings || !Array.isArray(gameweekMappings)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'gameweekMappings array is required'
            }, {
                status: 400
            });
        }
        // Get cup and verify admin access
        const { data: cup, error: cupError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('cups').select('league_id, stage').eq('id', cupId).single();
        if (cupError || !cup) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Cup not found'
            }, {
        ...
        const { data: existingGameweeks } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('cup_gameweeks').select('id').eq('cup_id', cupId).limit(1);
        ...
        const { data: groupData, error: groupError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('cup_groups').select('group_name, manager_id').eq('cup_id', cupId).order('group_name');
        if (groupError) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const groupAssignments = Object.entries(groupMap).map(([name, ids])=>({
                groupName: name,
                managerIds: ids
            }));
        // Generate group stage schedule
        const scheduleMatches = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$cup$2d$scheduling$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateGroupStageSchedule"])(groupAssignments);
        ...
        const cupGameweeksToInsert = gameweekMappings.map((mapping, index)=>{
        ...
        const { data: insertedGameweeks, error: gameweeksInsertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('cup_gameweeks').insert(cupGameweeksToInsert).select('id, cup_week');
        if (gameweeksInsertError) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: gameweeksInsertError.message
            }, {
                status: 500
            });
        }
        // Create mapping of cup_week to cup_gameweek_id
        const cupGameweekMap = {};
        insertedGameweeks.forEach((gw)=>{
            cupGameweekMap[gw.cup_week] = gw.id;
        });
        // Insert group stage cup matches
        const cupMatchesToInsert = scheduleMatches.map((match)=>({
                cup_id: cupId,
        ...
        const { data: insertedMatches, error: matchesInsertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('cup_matches').insert(cupMatchesToInsert).select();
        if (matchesInsertError) {
            // Rollback: delete created gameweeks
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('cup_gameweeks').delete().eq('cup_id', cupId);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: matchesInsertError.message
            }, {
                status: 500
            });
        }
        // Initialize group standings
        const standingsToInsert = groupAssignments.flatMap((group)=>group.managerIds.map((managerId)=>({
                    cup_id: cupId,
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('cup_group_standings').insert(standingsToInsert);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(request, context) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('cup_matches').delete().eq('cup_id', cupId);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Cup schedule deleted successfully'
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0fe1c915._.js.map