...
"[project]/src/app/api/leagues/[id]/players/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, context) {
    ...
    try {
        ...
        const { data: league, error: leagueError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('leagues').select('name').eq('id', leagueId).single();
        ...
        const { data: players, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('players').select(`
        id,
        name,
        surname,
        position,
      ...
      `).eq('league', league.name).order('name', {
            ascending: true
        });
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c50cf6e3._.js.map