...
"[project]/src/app/api/admin/leagues/[id]/lineups/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, context) {
    try {
        ...
        const { data: adminUser } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('users').select('id').eq('clerk_id', user.id).single();
        if (!adminUser) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const { data: league } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('leagues').select('admin_id').eq('id', leagueId).single();
        if (!league || league.admin_id !== adminUser.id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Unauthorized - not league admin'
            }, {
                status: 403
            });
        }
        ...
        if (playerIds.length < 1 || playerIds.length > 3) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Lineup must have between 1 and 3 players'
            }, {
                status: 400
            });
        }
        // Validate all players belong to manager's squad
        const { data: squad } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('squads').select(`
        id,
        squad_players!inner (
          player_id
        )
      `).eq('manager_id', managerId).eq('league_id', leagueId).single();
        if (!squad) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Manager has no squad in this league'
            }, {
                status: 404
            });
        }
        const squadPlayerIds = squad.squad_players.map((sp)=>sp.player_id);
        const invalidPlayers = playerIds.filter((id)=>!squadPlayerIds.includes(id));
        ...
        const { data: existingLineup } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('lineups').select('id').eq('manager_id', managerId).eq('gameweek_id', gameweekId).single();
        if (existingLineup) {
            // Update existing lineup
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('lineups').update({
                player_ids: playerIds,
                updated_at: new Date().toISOString()
            }).eq('id', existingLineup.id).select().single();
            if (error) {
            ...
            // Create new lineup
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('lineups').insert({
                manager_id: managerId,
                gameweek_id: gameweekId,
                player_ids: playerIds,
                is_locked: false,
...
async function GET(request, context) {
    try {
        ...
        const { data: squads } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('squads').select(`
        manager_id,
        users!inner (
          id,
          first_name,
      ...
      `).eq('league_id', leagueId);
        ...
        if (gameweekId) {
            const { data: lineups } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('lineups').select('*').eq('gameweek_id', gameweekId);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                managers,
                lineups: lineups || []
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b6d76878._.js.map